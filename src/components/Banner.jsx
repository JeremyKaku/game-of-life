            ...
            {({ isVisible }) => (
              ...
              >
                ...
                <p>
                  ...
                  simultaneously to every cell in the seed, live or dead; births
                  and deaths occur simultaneously, and the discrete moment at
                  which this happens is sometimes called a tick. Each generation
                  is a pure function of the preceding one. The rules continue to
                  be applied repeatedly to create further generations.
                </p>
                <Link to="/grid" className="btn-link">
                  <button className="btn">
                    Start the game! <ArrowRightCircle size={25} />
                  </button>
                </Link>
              </div>
            )}
